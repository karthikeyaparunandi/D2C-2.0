...
def perfcheck(nstart=0,nend=100,noisemax=100):
    ...
    #D2C
    i, x, y = np.loadtxt('swimmer_testing_data.txt', dtype=np.float64, delimiter=',\t',  unpack=True, usecols=(0,1,2))
    i = 100*i
    plt.figure(1)
    ...
    #DDPG
    DDPG_testing_data_location = "/media/karthikeya/Elements/DDPG_D2C/results/Swimmer3/exp_7/"
