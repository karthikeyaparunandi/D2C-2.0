...
if __name__=="__main__":
	...
	path_to_file = path_to_model_free_DDP+"/experiments/swimmer/exp_1/swimmer_policy.txt"
	training_cost_data_file = path_to_model_free_DDP+"/experiments/swimmer/exp_1/training_cost_data.txt"
